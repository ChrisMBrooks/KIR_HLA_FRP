rule run_rf_perm_test_v:
    ...
    params:
        ...
        n_jobs = 1
    output:
        results = "Output/{project}/RandomForest/{date_str}/Test{test_id}/Validation/rf_feature_importance_perm_values_2sig.{test_id}.{date_str}.csv",
        plot = "Output/{project}/RandomForest/{date_str}/Test{test_id}/Validation/rf_feature_importance_box_plot_2sig.{test_id}.{date_str}.png"
    log:         
        file = "Output/log/rf_perm_test.v.{project}.{test_id}.{date_str}.log.txt"
    threads: 1
    resources:
        mem_mb=1000
