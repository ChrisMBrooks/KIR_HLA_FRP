rule run_rf_univar_validation_opt:
    input:
        ...
        m_effectives = "Output/{project}/RandomForest/{date_str}/Test{test_id}/Optimised/rf_m_effective_results.{test_id}.{date_str}.csv",
    params:
        date_str = "{date_str}",
        test_id = "{test_id}",
        trn_test = False,
    ...
    output:
        results = "Output/{project}/RandomForest/{date_str}/Test{test_id}/Optimised/univar_final_scores.optimised.{test_id}.{date_str}.csv"
    log:
        file =  "Output/log/rf_univar_final_scores.optimised.{project}.{test_id}.{date_str}.log.txt"
    threads:1
    resources:
        mem_mb=1000
