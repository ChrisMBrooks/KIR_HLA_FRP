rule gen_mv_perf_test_hist:
    input:
        ...
        train_test_results = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/mv_train_test_score.{test_id}.{date_str}.csv"
    params: 
        date_str = "{date_str}",
        test_id = "{test_id}",
    ...
    output:
        ...
        p_val = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/mv_model_performance_cdf_results.{test_id}.{date_str}.csv"
    log:         
