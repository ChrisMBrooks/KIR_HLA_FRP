rule run_mv_univar_validation_v:
    input:
        ...
        m_effectives = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/Validation/mv_m_effective_results.{test_id}.{date_str}.csv",
    params:
        date_str = "{date_str}",
        test_id = "{test_id}",
        trn_test = False,
    ...
    output:
        results = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/Validation/univar_final_scores.{test_id}.{date_str}.csv"
    log:
        file =  "Output/log/en_univar_final_scores.v.{project}.{test_id}.{date_str}.log.txt"
    threads:1
    resources:
        mem_mb=1000
