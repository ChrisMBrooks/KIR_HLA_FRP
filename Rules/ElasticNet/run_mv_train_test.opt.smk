rule run_mv_train_test_opt:
    ...
    output:
        results = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/Optimised/mv_train_test_score.optimised.{test_id}.{date_str}.csv"
    log:
        file =  "Output/log/mv_trn_test.optimised.{project}.{test_id}.{date_str}.log.txt"
    threads: 1
    resources:
        mem_mb=1000
