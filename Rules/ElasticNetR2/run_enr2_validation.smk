rule run_enr2_validation:
    ...
    output:
        results = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/ElasticNetR2/Validation/enr2_final_score.{test_id}.{date_str}.csv"
    log:
        file =  "Output/log/enr2_validation.{project}.{test_id}.{date_str}.log.txt"
    threads: 1
    resources:
        mem_mb=1000
