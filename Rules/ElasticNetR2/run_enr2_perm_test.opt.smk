rule run_enr2_perm_test_opt:
    ...
    output:
        results = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/ElasticNetR2/Optimised/enr2_feature_importance_perm_values_2sig.optimised.{test_id}.{date_str}.csv",
        plot = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/ElasticNetR2/Optimised/enr2_feature_importance_box_plot_2sig.optimised.{test_id}.{date_str}.png"
    log:         
        file = "Output/log/enr2_perm_test.optimised.{project}.{test_id}.{date_str}.log.txt"
    threads: 1
    resources:
        mem_mb=1000
