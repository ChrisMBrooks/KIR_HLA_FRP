rule run_enr2_train_test_opt:
    ...
    output:
        results = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/ElasticNetR2/Optimised/enr2_train_test_score.optimised.{test_id}.{date_str}.csv"
    log:
        file =  "Output/log/enr2_trn_test.optimised.{project}.{test_id}.{date_str}.log.txt"
    threads: 1
    resources:
        mem_mb=1000
