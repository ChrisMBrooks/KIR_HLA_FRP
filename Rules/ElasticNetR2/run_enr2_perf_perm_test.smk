rule run_enr2_perf_perm_test:
    ...
    params:
        ...
        out_dir = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/ElasticNetR2/ParallelisedData"
    output:
        results = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/ElasticNetR2/ParallelisedData/enr2_model_performance_perm_values.{iteration_id}.{test_id}.{date_str}.csv",
    log:         
