rule run_enr2_train_test:
    ...
    output:
        results = "Output/{project}/ElasticNet/{date_str}/Test{test_id}/ElasticNetR2/enr2_train_test_score.{test_id}.{date_str}.csv"
    log:
        file =  "Output/log/enr2_train_test.{project}.{test_id}.{date_str}.log.txt"
    threads: 1
    resources:
        mem_mb=1000
