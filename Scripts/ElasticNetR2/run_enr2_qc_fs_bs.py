...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="ElasticNetR2 Sequential Feature Selection.",
...
def main():
    ...
    results_filename = os.path.join(output_dir, "enr2_seq_selection_candidates.{1}.{0}.csv".format(date_str, test_id))
    output_filename = os.path.join(output_dir, "enr2_seq_selection_summary.{1}.{0}.csv".format(date_str, test_id))
