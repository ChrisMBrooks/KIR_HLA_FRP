...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="ElasticNetR2 Grid Search w/ CV",
...
def main():
    ...
    feature_coefs_filename = os.path.join(output_dir, 'enr2_feature_coefs.{1}.{0}.csv'.format(date_str, test_id))
    output_filename = os.path.join(output_dir,'enr2_gs_run_summary_results.{1}.{0}.csv'.format(date_str, test_id))
    gs_details_filename = os.path.join(output_dir,'enr2_gs_details.{1}.{0}.csv'.format(date_str, test_id))
    plot_filename = os.path.join(output_dir,'enr2_gs_heat_map.{1}.{0}.png'.format(date_str, test_id))
