...
def get_output_filename(test_id:int, date_str:str, 
    ...
    output_filename = os.path.join(
        output_dir, 
        'rf_shuffled_train_validate_score.{iteration_id}.{test_id}.{date_str}.csv'.format(
            test_id = test_id, 
            date_str=date_str,
...
def get_train_validation_score_rf_r2(
    phenos_t:np.array,
    scores_t:np.array,
    phenos_v:np.array,
    scores_v:np.array,
...
train_validate_score = get_train_validation_score_rf_r2(
    phenos_t=phenos_r2, 
