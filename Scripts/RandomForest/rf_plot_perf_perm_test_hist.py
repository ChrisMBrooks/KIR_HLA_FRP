...
def main():
    ...
    filename_template = "rf_model_performance_perm_values.{it_id}.{test_id}.{date_str}.csv"

    consolidated_results_filename = os.path.join(
        output_directory, 
        "rf_model_performance_perm_values.{test_id}.{date_str}.csv".format(
            test_id=test_id, 
            date_str=date_str
        )
    )
    plot_filename = os.path.join(
        output_directory, 
        "rf_model_performance_perm_hist.{test_id}.{date_str}.png".format(
            test_id=test_id, 
            date_str=date_str
        )
    )
